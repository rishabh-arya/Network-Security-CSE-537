...
def main():
    ...
    Rand = LCG()
    l = Rand.random_array(NUMBER_OF_SAMPLES)
          
    l_median= statistics.median(l)
    Z = abs(runsTest(l, l_median))
    print("Z_critical: ", Z_critical_95_confidence)
    print("Z-statistic: ", Z)
    print("Null Hypothesis : The sequence was produced in a random manner")
    print("Alternate Hypothesis  : The sequence was not produced in a random manner")

...
if __name__ == '__main__':
    ...
    text= "10100100"
    # The below key_list contains keys with hamming distances 1, 2, 3, 4 and 5 with respect to original key.
    ...
    for i in range(len(key_list)):
        ...
        print("The key with hamming distance {} : {}".format(i+1,K))
        print("The bit sequence : ",string_to_bit_array(K))
    ...
    # Pair plot (Hamming distance VS No. of rounds)
    plt.figure(figsize=(16,14))
